...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    // Boolean to see if the user changed any of the fields
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String activityLabel = getString(R.string.editor_activity_title_new_pet);

        if (mCurrentPetUri != null) {
            activityLabel = getString(R.string.activity_editor_edit);
            Log.i("EDITOR_URI", mCurrentPetUri.toString());
        ...
        // Set onTouch listeners to see if the user changed any values
    ...
    /**
     * Gets user input and saves new pet into database
     */
    private void savePet() {
        ...
        // Do not add the pet if no information is provided
        if (mCurrentPetUri == null &&
        ...
        if (mCurrentPetUri == null) {
            ...
            if (newRowUri != null) {
                Toast.makeText(this, R.string.editor_insert_pet_successfully, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, R.string.editor_insert_pet_error, Toast.LENGTH_SHORT).show();
            }
        } else {
            // Update the new row, returning the row count
            int updatedRows = getContentResolver().update(mCurrentPetUri, values, null, null);

            if (updatedRows == 0) {
                Toast.makeText(this, R.string.editor_update_pet_error, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, R.string.editor_update_pet_successfully, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (data.moveToFirst()) {
            ...
            // Update the inputs with the data from cursor
